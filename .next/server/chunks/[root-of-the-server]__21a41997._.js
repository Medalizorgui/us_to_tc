...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/db.ts [app-route] (ecmascript)"); // Adjust the import path as necessary
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
async function POST(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect();
        const result = await client.query('INSERT INTO projects (name, description, created_at, updated_at) VALUES ($1, $2, NOW(), NOW()) RETURNING *', [
            name,
            description
        ]);
        client.release();
...
async function PUT(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect();
        const result = await client.query('UPDATE projects SET name = $1, description = $2, updated_at = NOW() WHERE id = $3 RETURNING *', [
            name,
            description,
            id
        ]);
...
async function DELETE(request) {
    try {
        ...
        const client = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].connect();
        const result = await client.query('DELETE FROM projects WHERE id = $1 RETURNING *', [
            id
        ]);
        client.release();
        if (result.rowCount === 0) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21a41997._.js.map